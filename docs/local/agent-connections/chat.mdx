...
Connect a text chat agent to evaluate your agent's logic without placing calls by [simulating conversations](/local/simulations) or [evaluating each turn](/local/text-to-text).
