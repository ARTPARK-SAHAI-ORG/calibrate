...
<CardGroup cols={2}>
  <Card
    title="Run Text to Speech Evaluation"
    icon="play"
    href="/guides/tts-evaluation"
  >
    Learn how to run Text to Speech evaluation across different providers
  </Card>
  <Card
    title="Configure Text to Speech in Agent"
    icon="gear"
    href="/guides/agent-tts-configuration"
  >
  ...
  <Card
    ...
    icon="code"
    href="/python-sdk/text-to-speech#running-provider-evaluation"
  >
  ...
  <Card
    ...
    icon="chart-bar"
    href="/python-sdk/text-to-speech#provider-leaderboard"
  >
