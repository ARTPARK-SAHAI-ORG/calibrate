...
description: "Run voice agent simulations with STT, LLM, and TTS"
---

Run end-to-end voice simulations combining Speech to Text, LLM, and Text to Speech.
...
Each simulation pairs every persona with every scenario, testing the full voice pipeline.

### Tools

Define tools that extend your agent's capabilities:
...
**Interruption Sensitivity** simulates realistic user interruptions:
...
```python
from calibrate.agent import STTConfig, TTSConfig, LLMConfig
...
- **TTS**: cartesia, google, openai, elevenlabs, sarvam, deepgram
