...
description: "Run full voice simulations with Speech to Text, LLM, and Text to Speech components."
---

Run full voice simulations that combine Speech to Text, LLM, and Text to Speech components.
...
# Define tools (see Tool Types section below for webhook tools)
tools = [
    {
...
Use `"type": "webhook"` for tools that call external APIs. Webhook tools make actual HTTP calls during voice simulations.
