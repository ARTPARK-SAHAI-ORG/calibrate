...
- `Human Alignment`: Calibrate your LLM judges against human labels to ensure your automated evaluations stay aligned with your intent
...
<CardGroup cols={2}>
  ...
  <Card title="Human Alignment" icon="scale-balanced" href="/quickstart/human-alignment">
    Calibrate your LLM judges against human ground truth labels
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Human Alignment" icon="scale-balanced" href="/core-concepts/human-alignment">
    Align your LLM judges with human ground truth
  </Card>
