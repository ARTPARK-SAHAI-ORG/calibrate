...
Calibrate is an open-source framework for automated, repeatable and systematic evaluation of voice agents at scale.
...
Calibrate solves this in two ways:
...
<CardGroup cols={2}>
  ...
  <Card title="Python SDK" icon="code" href="/python-sdk/overview">
    Use Calibrate programmatically.
  </Card>
