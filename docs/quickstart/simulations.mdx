...
Select your agent, personas, scenarios, and metrics. Each persona × scenario combination creates one simulated conversation.

<Frame>
  <img src="./images/sim_config_filled.png" alt="Simulation Configuration" />
</Frame>

Click **Create** to save the simulation configuration. This creates the simulation but does not run it yet.
...
Click any row to view the full transcript. The **Overall metrics** section shows aggregated pass rates.
...
Once complete, voice simulations show results with the **Performance** tab displaying evaluation metrics and STT LLM judge scores.
...
<Frame>
  <img src="./images/sim_voice_latency.png" alt="Voice Simulation Latency Metrics" />
</Frame>
