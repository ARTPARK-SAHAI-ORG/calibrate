...
For agent connections, Calibrate [verifies](/core-concepts/agent-connections#verify-your-connection) your agent on a sample input with each selected model **before** the benchmark can run. Every model you add to the comparison shows one of these states next to it:
