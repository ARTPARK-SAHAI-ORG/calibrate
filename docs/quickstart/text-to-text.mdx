...
<Note>
  The **End conversation** toggle allows the agent to hang up calls. Enable this
  for voice agents.
</Note>
...
<Tip>
  A faster model with slightly lower pass rate may be better for simple queries.
  Use the best model for complex reasoning.
</Tip>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="comments"
    href="/guides/simulations/overview"
  >
