...
Pense lets you evaluate multiple TTS providers simultaneously using your own dataset. This guide will walk you through creating an evaluation for your dataset.
