...
Run full voice agent simulations with Speech to Text, Text to Text, and Text to Speech components, or interact with an agent in real-time.
...
| `language` | string | Yes | `english`, `hindi`, or `kannada` |
