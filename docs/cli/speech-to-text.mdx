...
Prepare a directory with this structure:
...
Evaluate a Speech to Text provider on your dataset.
...
<Note>
  Sindhi STT is supported by Google (uses chirp_2 model), Cartesia, and
