...
The Calibrate MCP server exposes 41 tools across 7 categories:

| Category | Tools | Purpose |
| --- | --- | --- |
| [Agent tests](/mcp/tools#agent-tests) | `list-agent-test-runs`, `list-agent-tests`, `get-agent-benchmark`, `get-agent-test-run`, `bulk-unlink-agent-tests`, `run-agent-benchmark`, `run-agent-tests`, `run-agent-tests-batch`, `link-tests-to-agent` | Launch and monitor agent test runs |
