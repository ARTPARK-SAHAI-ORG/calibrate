...
The Calibrate MCP server exposes 42 tools across 7 categories:

| Category | Tools | Purpose |
| --- | --- | --- |
| [Agent tests](/mcp/tools#agent-tests) | `list-agent-test-runs`, `list-agent-tests`, `get-agent-benchmark`, `get-agent-test-case-result`, `get-agent-test-run`, `bulk-unlink-agent-tests`, `run-agent-benchmark`, `run-agent-tests`, `run-agent-tests-batch`, `link-tests-to-agent` | Launch and monitor agent test runs |
...
| [Annotation tasks](/mcp/tools#annotation-tasks) | `list-annotation-tasks`, `get-annotation-agreement`, `get-annotation-evaluator-run`, `get-annotation-summary`, `get-annotation-task`, `create-annotation-task`, `create-labelling-jobs`, `run-annotation-evaluators`, `update-annotation-items`, `add-annotation-items`, `set-task-evaluators` | Create and run annotation tasks |
| [Annotators](/mcp/tools#annotators) | `list-annotators`, `create-annotator`, `update-annotator` | — |
...
| [Traces](/mcp/tools#traces) | `create-trace` | — |
