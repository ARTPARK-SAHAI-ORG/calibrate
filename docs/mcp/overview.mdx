...
The Calibrate MCP server exposes 13 tools across 3 categories:

| Category | Tools | Purpose |
| --- | --- | --- |
| [Agent tests](/mcp/tools#agent-tests) | `get-agent-test-run`, `run-agent-tests`, `run-agent-tests-batch` | Launch and monitor agent test runs |
| [Agents](/mcp/tools#agents) | `list-agents`, `get-agent`, `resolve-agent-names`, `create-agent`, `update-agent` | Manage the agents in your workspace |
