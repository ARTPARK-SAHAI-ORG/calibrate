...
The Calibrate MCP server exposes 33 tools across 5 categories:
...
| [Agents](/mcp/tools#agents) | `list-agents`, `get-agent`, `resolve-agent-names`, `create-agent`, `update-agent`, `verify-agent-connection` | Manage the agents in your workspace |
| [Annotation tasks](/mcp/tools#annotation-tasks) | `list-annotation-tasks`, `get-annotation-agreement`, `get-annotation-evaluator-run`, `get-annotation-summary`, `get-annotation-task`, `create-annotation-task`, `run-annotation-evaluators`, `update-annotation-items`, `add-annotation-items`, `link-evaluator-to-task` | Create and run annotation tasks |
