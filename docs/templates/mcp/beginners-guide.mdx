...
<Tip>
  Point your coding agent at the full docs index at
  [calibrate.artpark.ai/llms.txt](https://calibrate.artpark.ai/llms.txt) so it can
  discover every page on its own.
</Tip>
