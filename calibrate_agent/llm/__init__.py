...
class _Tests:
    ...
    async def _run_single_model(
        ...
        from calibrate_agent.utils import configure_print_logger, log_and_print
        ...
        if errored:
            ...
            log_and_print(
                ERRORED_SUMMARY.format(errored=errored, total=total_tests)
            )
    ...
    async def run_inference(
        ...
        """
        from calibrate_agent.llm.run_tests import run_inference as _run_inference
...
class _Simulations:
    ...
    async def run_simulation(
        ...
        """
        from calibrate_agent.llm.run_simulation import run_simulation as _run_simulation
